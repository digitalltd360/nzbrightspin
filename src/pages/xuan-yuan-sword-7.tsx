...
const XuanYuanSword7Page = () => {
  const features = [
    {
      title: "ANCIENT CHINA REIMAGINED",
      description:
        "Experience a celebration of ancient China's landscape, civilization and culture, infused with the mystique of its own legends.",
      icon: <Psychology />,
      color: "#007bff",
    },
    {
      ...
      description:
        "A world that is both familiar and mysterious, one of both science and spirituality, one that is waiting to be explored.",
      icon: <Build />,
      color: "#ffc107",
    },
    {
      ...
      description:
        "Immerse yourself in a rich narrative that blends historical elements with fantastical storytelling.",
      icon: <Security />,
      color: "#dc3545",
    },
    {
      ...
      description:
        "Discover the depth of Chinese mythology and tradition through stunning visuals and engaging gameplay.",
      icon: <Speed />,
      color: "#28a745",
    },
  ];
          ...
          >
            <Box sx={{ textAlign: "center", mb: 8 }}>
              ...
              >
                ...
                >
                  It&apos;s a celebration of ancient China&apos;s landscape,
                  civilization and culture, infused with the mystique of its own
                  legends in stark contrast to anachronistic technological
                  designs. A world that is both familiar and mysterious, one of
                  both science and spirituality, one that is waiting to be
                  explored.
                </Typography>
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            >
              ...
              Studios with the porting of Xuan Yuan Sword 7, a complex RPG that
              required careful attention to cultural authenticity and technical
              excellence. Our team worked closely with the original developers
              to ensure that the game&apos;s rich narrative and stunning visuals
              were preserved across all target platforms.
            </Typography>
            <br />
            <Typography
              variant="body1"
            ...
            >
              ...
              rendering pipeline for different hardware configurations while
              maintaining the visual fidelity that makes Xuan Yuan Sword 7 such
              a compelling experience. We focused on ensuring smooth performance
            ...
            >
              ...
              performance without compromising its artistic vision. The result
              is a seamless experience that brings the beauty of ancient China
...
export default XuanYuanSword7Page;
