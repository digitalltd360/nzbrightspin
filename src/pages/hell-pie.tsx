...
const HellPiePage = () => {
  const features = [
    {
      title: "GROTESQUE COMEDY",
      description:
        "Experience a grotesque but very funny 3D platformer with unique humor and outrageous scenarios.",
      icon: <Psychology />,
      color: "#007bff",
    },
    {
      title: "DEMON OF BAD TASTE",
      description:
        "Control Nate, the 'Demon of Bad Taste', in the most crucial mission of his hellish life.",
      icon: <Build />,
      color: "#ffc107",
    },
    {
      title: "SATAN'S BIRTHDAY CAKE",
      description:
        "You must bake Satan's birthday cake! In search of ingredients, Nate will jump through the most disgusting corners of the underworld.",
      icon: <Security />,
      color: "#dc3545",
    },
    {
      title: "3D PLATFORMER",
      description:
        "Navigate through challenging 3D environments with unique platforming mechanics and hilarious obstacles.",
      icon: <Speed />,
      color: "#28a745",
    },
  ];
          ...
          >
            <Box sx={{ textAlign: "center", mb: 8 }}>
              ...
              >
                ...
                >
                  Hell Pie (Sluggerfly) is a grotesque but very funny 3D
                  platformer. Here we control Nate, the &quot;Demon of Bad
                  Taste&quot;, in the most crucial mission of his hellish life.
                  You must bake Satan&apos;s birthday cake! In search of
                  ingredients, Nate will jump through the most disgusting
      ...
      <Box sx={{ py: 12, background: "#ffffff" }}>
        <Container maxWidth="xl">
          ...
          >
            ...
            >
              Sluggerfly entrusted Catness Game Studios with the porting of Hell
              Pie, a unique 3D platformer that required careful attention to its
              distinctive art style and comedic elements. Our team worked
              closely with the original developers to ensure that the
              game&apos;s grotesque humor and platforming mechanics were
            ...
            <Typography
              ...
              sx={{ lineHeight: 1.8, fontSize: "1.1rem" }}
            >
              The porting process involved optimizing the game&apos;s 3D
              rendering pipeline and physics systems for different hardware
              configurations while maintaining the visual style that makes Hell
              Pie such a distinctive experience. We focused on ensuring smooth
            ...
            >
              ...
              performance without compromising its unique visual style. The
              result is a seamless experience that brings the grotesque humor of
              Hell Pie to players worldwide.
            </Typography>
          </Paper>
        </Container>
      </Box>
